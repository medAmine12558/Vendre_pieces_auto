...
namespace Vendre_pieces_auto.Migrations
{
    ...
    [Migration("20240622042605_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Vendre_pieces_auto.Models.Tabels.CommandePiece", b =>
                {
                    ...
                    b.HasKey("Piece_id", "Commande_id");

                    b.HasIndex("Commande_id");

                    b.ToTable("CommandePiece");
                });
            ...
            modelBuilder.Entity("Vendre_pieces_auto.Models.Tabels.CommandePiece", b =>
                {
                    ...
                    b.HasOne("Vendre_pieces_auto.Models.Tabels.Piece", "Pieces")
                        .WithMany("Commanders")
            ...
            modelBuilder.Entity("Vendre_pieces_auto.Models.Tabels.Facture", b =>
                {
                    b.HasOne("Vendre_pieces_auto.Models.Tabels.Commande", "Commandee")
                        .WithMany()
                        .HasForeignKey("Id_Comm")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Commandee");
                });
