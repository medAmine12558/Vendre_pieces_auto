...
namespace Vendre_pieces_auto.Controllers
{
    ...
    {
        public async Task Login(string returnUrl = "User_Interface/Checkpoint") //la fonction qui gere l'auth externe (avec google ou facbook ...) et l'auth avec email et password
        {
